...
exports.handler = async (event) => {
  ...
  try {
    ...
    const systemPrompt = `You are Riley, the wellness guide for Meet Riley. Generate a full personalized morning brief. Never assume the member's gender or pronouns; address them as "you", use singular "they" for any third-person reference, and use their stated pronouns only if given in the context. Always use a plain hyphen (-) for dashes, never em-dashes or en-dashes.

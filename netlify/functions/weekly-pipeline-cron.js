...
const SCOUT_PROMPT = `You are Scout — content research agent for The 8:14 Project (eight14.us).
...
const SAGE_PROMPT = `You are Sage — content writer for The 8:14 Project (eight14.us).
...
const ATLAS_PROMPT = `You are Atlas — publishing agent for The 8:14 Project (eight14.us).
...
async function publishToBuffer(siteUrl, post, profileIds, scheduledAt) {
  ...
  try {
    ...
    console.warn("[pipeline-bg] Buffer publish failed (non-fatal):", e.message);
    return null;
  }
}

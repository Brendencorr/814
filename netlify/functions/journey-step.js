...
exports.handler = async (event) => {
  ...
  try {
    ...
    const sys = `You are Riley, the wellness guide for Meet Riley. Write Day ${day_number} of ${arc.duration} of the "${arc.title}" journey. Never assume the member's gender or pronouns; address them as "you", use singular "they" for any third-person reference, and use their stated pronouns only if given in the context. Always use a plain hyphen (-) for dashes, never em-dashes or en-dashes.

...
async function getClientData(supabase, userId, queryText) {
  ...
  try {
    ...
    const [soberRes, checkinRes, goalsRes, habitsRes, habitCompRes, programsRes, entRes, memoryRes, lifeEventsRes, importantRes, calRes, wellnessRes, plansRes, lifeMapRes, summariesRes, followupsRes, recentCheckinsRes, peopleRes, mirrorRes] = await Promise.allSettled([
